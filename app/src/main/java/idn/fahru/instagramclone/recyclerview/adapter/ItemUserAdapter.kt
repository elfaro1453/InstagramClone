package idn.fahru.instagramclone.recyclerview.adapter
...
import idn.fahru.instagramclone.recyclerview.viewholder.ItemUserVH
...
class ItemUserAdapter : RecyclerView.Adapter<ItemUserVH>() {
    ...
    // buat fungsi konvert dp (density) ke px (pixel)
